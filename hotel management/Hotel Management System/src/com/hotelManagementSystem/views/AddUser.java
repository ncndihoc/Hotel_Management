...
//        setLocationRelativeTo(null);
    ...
    private void initComponent() {
        ...
        comboBox.setBounds(200, 330, 150, 27);
        ...
        l8.setBounds(60, 430, 150, 27);
        p1.add(l8);

        t5 = new JTextField();
        t5.setBounds(200, 430, 150, 27);
        ...
        l9.setBounds(60, 480, 150, 27);
        p1.add(l9);

        t6 = new JTextField();
        t6.setBounds(200, 480, 150, 27);
